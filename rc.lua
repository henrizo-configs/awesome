...
beautiful.wallpaper = "/mnt/myStuff/wallpapers/arch.jpg"
...
globalkeys = gears.table.join(
   ...
   --
   awful.key({modkey, "Shift"}, "b", function () awful.spawn("setxkbmap -layout br") end),
   awful.key({modkey, "Shift"}, "d", function () awful.spawn("setxkbmap -layout de") end),
   awful.key({modkey, "Shift"}, "u", function () awful.spawn("setxkbmap -layout us") end),
